...
ui_manager = UIManager((frame_size_x, frame_size_y))
...
quit_button = UIButton(relative_rect=pygame.Rect((10, 10), (100, 50)), text='Quit', manager=ui_manager)
...
while running:
    ...
    ui_manager.update()
    ui_manager.draw_ui(game_window)
